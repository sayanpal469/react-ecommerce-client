...
import {
  ...
  selectTotalItems,
} from "../../product-list/productListSlice.js";
...
ProductGrid.propTypes = {
  ...
  status: PropTypes.oneOf(["loading", null]).isRequired,
};

export default AdminProductList;

AdminProductList.propTypes = {
  // You can add more specific PropTypes based on your component's requirements
  // For now, I'll add basic PropTypes for the existing props.
